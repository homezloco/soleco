...
class TestSerialization(unittest.TestCase):
    ...
    def test_serialize_complex_nested_structure(self):
        ...
        # Debug the result
        self.logger.debug(f"Type of result: {type(result)}")
    ...
    def test_serialize_with_error(self):
        ...
        # Create a custom class that raises an exception when its serialization methods are accessed
        class ErrorObject:
            def __init__(self):
                self._dict = {"key": "value"}
                
            def to_json(self):
                raise Exception("to_json error")
                
            def to_dict(self):
                raise Exception("to_dict error")
                
            @property
            def __dict__(self):
                raise Exception("__dict__ access error")
        
        # Create an instance of the error-raising object
